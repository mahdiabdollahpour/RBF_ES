...
# from examples.binary_classif_test import test
# x_train, y_train = utils.load_excel_data("2clstrain1200.xlsx")
...
#
# print(
#     RBF.evaluator(RBF.binary_classification_loss, x_train=x_train, y_train=y_train, x_test=x, y_test=y,
#                   individual=ind))
#
# y_out = RBF.get_y_binary_classification(individual=ind, x_train=None, y_train=None, x_test=x)
# print(y_out)
# ax = plt.gca()
# ax.cla()  # clear things for fresh plot
# for i in range(number_of_circles):
